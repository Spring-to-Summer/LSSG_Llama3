...
class CustomTrainingArguments(TrainingArguments):
    ...
    semantic_coeff: float = field(
        default=1.0, metadata={"help": "semantic_coeff."}
    )


    emotion_coeff: float = field(
        default=1.0, metadata={"help": "emotion_coeff."}
    )
    ...
    entropy_coeff: float = field(
        default=0.0, metadata={"help": "the coefficient of entropy."}
    )
